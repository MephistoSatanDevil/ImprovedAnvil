REPLACE WSMITH01
  IF ~~ THEN BEGIN 13
    ...
    IF ~PartyHasItem("S!blun01")~ THEN REPLY @622 GOTO treefist
...
APPEND WSMITH01
  ...
  IF ~~ THEN BEGIN mazzy
    ...
    IF ~Global("Iadracoldead","GLOBAL",1) Dead("S!dracol") PartyHasItem("npsw01") NumItemsPartyGT("scrl58",2) PartyHasItem("sw1h27") PartyHasItem("sw1h74") PartyHasItem("scrl5i") NumItemsPartyGT("scrl6m",1) PartyHasItem("S!misc02") PartyHasItem("S!misc33") PartyGoldGT(74999)~
      THEN REPLY @3
      DO ~TakePartyGold(75000)      DestroyGold(75000)
